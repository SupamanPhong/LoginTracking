...
def do_upload():
    ...
    try:
        ...
        if "XML" in logtype:
            logoption = " -x "
        parse_command = " python " + FPATH + "/logontracer.py --delete -z " + timezone + logoption + filelist + " -u " + NEO4J_USER + " -p " + NEO4J_PASSWORD + " >  " + FPATH + "/static/logontracer.log 2>&1 &";
